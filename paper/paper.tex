...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.0541}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1405}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1568}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1243}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1351}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1568}}
  >{\centering\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1459}}
